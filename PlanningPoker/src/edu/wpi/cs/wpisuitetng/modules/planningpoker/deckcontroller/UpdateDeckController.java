...
public class UpdateDeckController {
	...
	public void sendGame(Deck ToSend){
		...
		request.addObserver(new UpdateDeckRequestObserver()); // add an observer to process the response
	 ...
	 * @param game
	 */
	public void addGameToModel(Deck deck) {
		model.addDeck(deck);
	}
