...
public class VoteData extends JPanel{
	...
	public VoteData(GameSession gs, CompleteView cv){
		...
		reqNameText.setBorder(javax.swing.BorderFactory.createEmptyBorder());
	...
	private void init(){
		...
		springLayout.putConstraint(SpringLayout.EAST, reqNameText, -10, SpringLayout.EAST, this);
		
		//Spring layout constraints for reqDescriptionLabel
		springLayout.putConstraint(SpringLayout.NORTH, reqDescriptionLabel, 20, SpringLayout.SOUTH, reqNameLabel);
		...
		springLayout.putConstraint(SpringLayout.WEST, estimatesPane, -245, SpringLayout.EAST, estimatesPane);
		...
		springLayout.putConstraint(SpringLayout.WEST, sendEstimatesButton, 20, SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.EAST, sendEstimatesButton, -20, SpringLayout.WEST, estimatesPane);
		...
		springLayout.putConstraint(SpringLayout.EAST, finalSubmitButton, 10, SpringLayout.EAST, reqDescriptionLabel);
