 ...
 * @version Mar 24, 2014
 */
public class NewGameLivePanel extends JPanel {
	...
	private void setPanel(){
		...
		//springLayout.putConstraint(SpringLayout.NORTH, userList, 80, SpringLayout.NORTH, this);
		//springLayout.putConstraint(SpringLayout.SOUTH, userList, 44, SpringLayout.NORTH, this);
		//springLayout.putConstraint(SpringLayout.EAST, userList, 203, SpringLayout.WEST, this);
		...
		//springLayout.putConstraint(SpringLayout.WEST, userList, 122, SpringLayout.WEST, this);
		...
		add(minuteInput);
		add(userLabel);
		//userList.setForeground(Color.MAGENTA);
		//userList.setBackground(Color.MAGENTA);
		//add(userList);
		add(addButton);
		add(deleteButton);
		add(backButton);
